...
import { scout, outHarvest, outCarry, outBuild, outClaim, outDefend, outInvader, outAttack, outRanged, outMiner } from '@/roles';
...
import { defend_attack, defend_ranged } from '@/roles';
import { quad_attack, quad_heal, quad_dismantle, quad_ranged } from '@/roles';
...
export const RoleData: RoleConfig = {
    /* 基本房间运营 */
    'harvester': { num: 0, ability: [1, 1, 2, 0, 0, 0, 0, 0], level: 3, code: 'H', work: harvester },  // 采集
    'carrier': { num: 0, ability: [0, 3, 3, 0, 0, 0, 0, 0], level: 4, code: 'C', work: carrier },  // 矿点搬运
    'transport': { num: 0, ability: [0, 2, 2, 0, 0, 0, 0, 0], level: 2, code: 'T', mission: transport }, // 资源运输填充
    'manage': { num: 0, ability: [0, 1, 1, 0, 0, 0, 0, 0], level: 1, code: 'M', mission: manage }, // 中央搬运
    'upgrader': { num: 0, ability: [1, 1, 2, 0, 0, 0, 0, 0], level: 10, code: 'U', work: upgrader }, // 升级
    'builder': { num: 0, ability: [1, 1, 2, 0, 0, 0, 0, 0], level: 10, code: 'B', work: builder }, // 建造
    'repair': { num: 0, ability: [1, 1, 1, 0, 0, 0, 0, 0], level: 8, code: 'R', work: repair }, //维修、刷墙
    'miner': { num: 0, ability: [1, 1, 2, 0, 0, 0, 0, 0], level: 6, code: 'MR', work: miner }, // 矿工

    /* 特殊用途 */
    'scout': { num: 0, ability: [0, 0, 1, 0, 0, 0, 0, 0], level: 11, code: 'S', work: scout },
    'har-car': { num: 0, ability: [1, 1, 2, 0, 0, 0, 0, 0], level: 0, code: 'HC', work: harvest_carry }, // 采集搬运一体机，处理停摆状况
    'speedup-upgrade': { num: 0, ability: [2, 1, 1, 0, 0, 0, 0, 0], level: 11, code: 'SU', work: SpeedUpgrader }, // 加速升级
    'speedup-repair': { num: 0, ability: [30, 5, 15, 0, 0, 0, 0, 0], level: 11, code: 'SR', work: SpeedRepair }, // 加速刷墙
    'logistic': { num: 0, ability: [0, 2, 2, 0, 0, 0, 0, 0], level: 10, code: 'L', work: logistic }, // 长途运输
    ...
    'big-carry': { num: 0, ability: [0, 40, 10, 0, 0, 0, 0, 0], level: 10, code: 'BC', work: bigCarry },  // 大体型搬运

    /* 占领房间 */
    'claimer': { num: 0, ability: [0, 0, 4, 0, 0, 0, 4, 0], level: 11, code: 'CL', work: claimer },
    ...
    /* 援建 */
    // 'aid-build': { num: 0, ability: [20, 5, 25, 0, 0, 0, 0, 0], level: 11, code: 'AIDB', work: aid_build },
    ...
    'defend-ranged': { num: 0, ability: [0, 0, 10, 0, 40, 0, 0, 0], level: 8, code: "DFR", must: true, action: defend_ranged },
    ...
    'out-claim': { num: 0, ability: [0, 0, 5, 0, 0, 0, 5, 0], level: 11, code: 'OCL', work: outClaim },
    'out-harvest': { num: 0, ability: [4, 2, 4, 0, 0, 0, 0, 0], level: 12, code: 'OH', work: outHarvest },
    'out-car': { num: 0, ability: [1, 5, 6, 0, 0, 0, 0, 0], level: 13, code: 'OC', work: outCarry},
    'out-carry': { num: 0, ability: [0, 5, 5, 0, 0, 0, 0, 0], level: 13, code: 'OC', work: outCarry},
    'out-build': { num: 0, ability: [1, 5, 6, 0, 0, 0, 0, 0], level: 13, code: 'OB', work: outBuild },
    'out-defend': { num: 0, ability: [0, 0, 5, 5, 0, 5, 0, 0], level: 8,code: 'OD', work: outDefend},
    'out-invader': { num: 0, ability: [0, 0, 5, 5, 0, 6, 0, 0], level: 10, code: 'OI', work: outInvader},
    'out-attack': { num: 0, ability: [0, 0, 25, 19, 0, 6, 0, 0], level: 9, code: 'OA', action: outAttack},
    'out-ranged': { num: 0, ability: [0, 0, 25, 0, 15, 10, 0, 0], level: 9, code: 'OR', action: outRanged},
    ...
    /* Power */
    'power-attack': { num: 0, ability: [0, 0, 25, 20, 0, 0, 0, 5], level: 10, code: 'PA', action: power_attack },
    'power-heal': { num: 0, ability: [0, 0, 25, 0, 0, 25, 0, 0], level: 10, code: 'PH', action: power_heal },
    'power-carry': { num: 0, ability: [0, 25, 25, 0, 0, 0, 0, 0], level: 9, code: 'PC', work: power_carry },
    'power-ranged': { num: 0, ability: [0, 0, 25, 0, 17, 8, 0, 0], level: 11, code: 'PR', action: power_ranged },
